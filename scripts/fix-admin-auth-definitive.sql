-- CORREÇÃO DEFINITIVA DO SISTEMA DE AUTENTICAÇÃO ADMIN
-- Este script limpa completamente o sistema e cria uma implementação única e robusta
...
-- ETAPA 5: CRIAR SUPERADMIN COM SENHA SIMPLES (TEXTO PLANO)
-- Primeiro remove qualquer superadmin existente para evitar conflitos
DELETE FROM public.admins WHERE email = 'superadmin@sistema.com';

-- Cria superadmin com senha em texto plano para teste inicial
...
-- ETAPA 6: CRIAR FUNÇÃO ÚNICA E ROBUSTA DE LOGIN
...
-- ETAPA 7: CRIAR FUNÇÃO DE VERIFICAÇÃO DE TOKEN
...
-- ETAPA 8: CONFIGURAR PERMISSÕES CORRETAS
...
-- ETAPA 9: CONFIGURAR RLS (Row Level Security)
...
-- ETAPA 10: TESTE FINAL DA FUNÇÃO
...
SELECT 'SISTEMA DE AUTENTICAÇÃO ADMIN CORRIGIDO COM SUCESSO!' as status;